...
| ------------- | --------------------------------- | --------------------------------------- |
| **`core-`**   | `core-imgtor.test.js`, `core-canvas-adapter-native.test.js`, `core-editor-canvas.test.js`, `core-init.test.js`, `core-icon-sprite.test.js` | imgtor core, adapters, icon sprite, UI |
