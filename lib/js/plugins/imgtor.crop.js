(function () {
  ...
  imgtor.plugins['crop'] = imgtor.Plugin.extend({
    ...
    initialize: function initImgTorCropPlugin() {
      ...
      // Canvas events
      this.imgtor.canvas.on('mouse:down', this.onMouseDown.bind(this));
      this.imgtor.canvas.on('mouse:move', this.onMouseMove.bind(this));
      this.imgtor.canvas.on('mouse:up', this.onMouseUp.bind(this));
      this.imgtor.canvas.on('object:moving', this.onObjectMoving.bind(this));
      this.imgtor.canvas.on('object:scaling', this.onObjectScaling.bind(this));

      fabric.util.addListener(fabric.document, 'keydown', this.onKeyDown.bind(this));
      fabric.util.addListener(fabric.document, 'keyup', this.onKeyUp.bind(this));

      this.imgtor.addEventListener('core:transformation', this.releaseFocus.bind(this));
    },
    ...
    _renderCropZone: function (fromX, fromY, toX, toY) {
      ...
      if (rightX - leftX < minWidth) {
        if (isRight) rightX = leftX + minWidth;
        else leftX = rightX - minWidth;
      }
      if (bottomY - topY < minHeight) {
        if (isDown) bottomY = topY + minHeight;
        else topY = bottomY - minHeight;
      }
      ...
      if (this.options.ratio && +this.options.ratio !== currentRatio) {
        ...
        if (leftX + width > canvas.getWidth()) {
          const maxWidth = canvas.getWidth() - leftX;
        ...
        if (topY + height > canvas.getHeight()) {
          const maxHeight = canvas.getHeight() - topY;
