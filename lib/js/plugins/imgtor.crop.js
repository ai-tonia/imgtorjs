(function () {
  ...
  imgtor.plugins['crop'] = imgtor.Plugin.extend({
    ...
    initialize: function initImgTorCropPlugin() {
      ...
      fabric.util.addListener(fabric.document, 'keydown', this._onKeyDown);
      fabric.util.addListener(fabric.document, 'keyup', this._onKeyUp);
    ...
    destroy: function destroyCropPlugin() {
      ...
      if (typeof fabric !== 'undefined' && fabric.util) {
        if (this._onKeyDown) fabric.util.removeListener(fabric.document, 'keydown', this._onKeyDown);
        if (this._onKeyUp) fabric.util.removeListener(fabric.document, 'keyup', this._onKeyUp);
      }
