(function () {
  ...
  imgtor.prototype = {
    ...
    /** @type {typeof imgtor.CanvasAdapterFabric | null} */
    _canvasAdapter: null,
    ...
    _initializeDOM: function (imageElement) {
      ...
      if (this.options.adapterKind === 'native') {
        if (!imgtor.CanvasAdapterNative) {
          throw new Error(
            '[imgtor] CanvasAdapterNative is missing — load the native bundle (build/imgtor-native.js) or the full bundle.',
          );
        }
        this._canvasAdapter = imgtor.CanvasAdapterNative;
      } else {
        if (!imgtor.CanvasAdapterFabric) {
          throw new Error(
            '[imgtor] CanvasAdapterFabric is missing — load Fabric.js and build/imgtor.js.',
          );
        }
        this._canvasAdapter = imgtor.CanvasAdapterFabric;
      }
      const canvasOpts = {
        selection: false,
